const levels = [
    ...
    new GameLevel(4, 5, 4, 0.9, 70, 1250),
    new GameLevel(5, 5, 5, 0.95, 75, 1000),
    new GameLevel(6, 5, 6, 1.0, 75, 950),
    new GameLevel(7, 6, 7, 1.1, 80, 900),
    new GameLevel(8, 6, 8, 1.2, 80, 850),
